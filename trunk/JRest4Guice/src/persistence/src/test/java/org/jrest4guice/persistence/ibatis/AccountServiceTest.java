...
public class AccountServiceTest {
	...
	public static void setUp() throws Exception {
		// 初始化JRest4Guice
		PersistenceGuiceContext.getInstance().useIbatis("org.jrest4guice.persistence.ibatis").init();
		// 获取服务
	...
	public void doTest(){
		...
		try {
			...
			for(Account ac:accounts)
				System.out.println(ac.getFirstName()+ac.getLastName()+"的邮件地址是："+ac.getEmailAddress());
