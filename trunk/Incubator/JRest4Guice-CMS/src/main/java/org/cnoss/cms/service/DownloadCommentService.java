/*
 * @(#)DownloadCommentService.java   08/06/13
 * 
...
import org.cnoss.cms.entity.DownloadComment;
...
public interface DownloadCommentService {
     ...
     */
    public List<DownloadComment> getComments(Long downloadId, String keyword, int pageIndex, int pageSize)
