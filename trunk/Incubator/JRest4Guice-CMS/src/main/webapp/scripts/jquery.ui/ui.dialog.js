(function($)
{
	...
	$.ui.dialog = function(el, o) {
		...
		if (jQuery.browser.msie && jQuery.browser.version < 7) {
			uiDialog.append('<iframe style="z-index:-1;filter:progid:dximagetransform.microsoft.alpha(style=0,opacity=0);position:absolute;left:0;top:0;width:100%;height:100%;" src="javascript:void(0)"></iframe>');
		}		
